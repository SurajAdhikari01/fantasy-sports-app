    ...
    <SafeAreaView className="flex-1 bg-gray-900">
      ...
      >
        <View className="flex-row items-center justify-between mb-4">
          ...
          <TouchableOpacity
            className="p-2 bg-gray-800 flex-row justify-center items-center rounded-full"
            onPress={saveTeam}
          >
            <Text className="text-white font-bold p-2">Save</Text>
            {/*  <Ionicons name="checkmark-outline" size={24} color="white p-2" /> */}
          </TouchableOpacity>
        </View>
      </LinearGradient>
